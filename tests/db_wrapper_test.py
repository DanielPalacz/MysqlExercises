...
class TestDbWrapperInit:
    def test_init(self):
        test_creds = {"host": "host1", "user": "user1", "password": "password1"}
    ...
    @pytest.mark.parametrize(
        "funct_kwargs",
        [
            {"host": "host1", "user": "user1", "password": 123456},
            {"host": "host1", "user": None, "password": "password1"},
            {"host": range(1), "user": "user1", "password": "password1"},
        ],
    )
